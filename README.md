...
Я занимаюсь [веб-разработкой](https://vallek.github.io/dev/) и [образованием](https://vallek.github.io/pages/courses/web). Работаю фрилансером, консультантом, автором курсов, преподавателем. Cоздаю образовательные проекты.

Решаю бизнес-задачи клиентов. Помогаю студентам преодолевать трудности в обучении. Умею делать адаптивную, современную фронтенд-верстку по лучшим практикам и писать поддерживаемый код [без AI](https://vallek.github.io/ai-sucks/). 
...
## 🔎 Я ищу работу
* веб-разработчиком, фротендером-верстальщиком, консультантом
